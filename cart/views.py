...
from  core.models import Customer  # Import your Customer model
...
class CartHomeView(LoginRequiredMixin, View):
    ...
    #     user_cart = Cart.objects.get_or_create(customer=request.user)[0]
...
class AddToCartView(LoginRequiredMixin, View):
    ...
    def post(self, request, barcode):
        ...
        if request.user.is_authenticated:
            ...
            cart, created = Cart.objects.get_or_create(Customer,customer=customer_instance)
